...
import Order_list from '../components/business_report/Order_list';
    ...
    <div className="site_main_wrap">
        ...
        <header>
           <div className="d-flex flex-wrap bg-white align-items-center pl-3 py-2">
               <button className="border-0 bg-transparent left-bar-opner d-lg-none"><i className="fa fa-bars"></i></button>
               <div className="site-logo">
                  <img src={logo} height="50px" />
               </div>
               <div className="site-searchbar ml-4">
                   <div className="input-group-set position-relative">
                      <input className="header-field" type="text" placeholder="Type your keywords" />
                ...
                <div class="ml-auto pr-4">
                    <button type="button" onClick={this.onLogout}  title="Logout" className="logout-trigger">Logout</button>
                </div>
           </div>
                ...
                <div className="left-sidebar-links">
                    <ul className="list-unstyled px-2">
                        <li className="text-center mb-5">
                           <NavLink activeClassName="active" to="/"><img src={dashboard_img} /></NavLink>
                        </li>
                        <li className="text-center mb-5">
                        ...
                        <li class="text-center mb-5">
                           <NavLink to="/businessReports" activeClassName="active"> 
                                <i><FontAwesomeIcon icon={faFileAlt} /></i>
                           </NavLink>
                        </li>
                        <li className="text-center mb-5">
                            <NavLink to="" activeClassName="active"> <img src={transfer_img} /></NavLink>
                        </li>
                        <li className="text-center mb-5">
                            <NavLink to="/pages" activeClassName="active"> <img src={info_img} width="33px" /></NavLink>
                        </li>
                    </ul> 
                </div>
            </div>
        ...
        <Switch>
            <Suspense fallback={Progress_bar} >
                <Route exact path="/">
                    <Home username={this.props.username} useravatar={this.props.useravatar} />
                </Route>
                 <Route exact path="/pages" component={Pages}>
                </Route>
                 <Route  exact path="/user_management" component={User_management}>
                </Route>
                <Route exact path="/businessReports" component={Order_list}></Route>
            </Suspense>
        </Switch>
        </Router>
    </div>
