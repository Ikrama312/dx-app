...
class Login extends React.Component {
    ...
    componentDidMount() {
        ...
        if (accessToken) {
            ...
            Services.admin.getProfile().then(response => {
                this.setState({
                    LoggedIn: true
                })
            }).catch((error) => {
    ...
    onLogin = () => {
        ...
        Services.admin.login(email, password).then(response => {
            ...
            localStorage.setItem(keys.Preference.REFRESH_TOKEN, tokens.refresh.token);
            this.setState({
                LoggedIn: true,
                ...
                {(() => {
                    if(this.state.loading==true){
                       ...
                       if (this.state.LoggedIn == false) {
                            ...
                            <div className="limiter">
                                <div className="container-login100">
                                    <div className="wrap-login100 position-relative">
                                        {this.state.message !== ''?  <div className="alert custom-alert text-center br-tb-0 w-100 position-absolute alert-danger" role="alert">
                                        ...
                                        <div className="login100-form validate-form">
                                            ...
                                            <div className="wrap-input100 validate-input">
                                                <input className="input100" type="text" name="email" onChange={(input) => this.setState({email:input.target.value})} placeholder="Email" />
                                            ...
                                            <div className="wrap-input100 validate-input" >
                                                <input className="input100" type="password" name="pass" onChange={(input) => this.setState({password:input.target.value})} placeholder="Password" />
                                                <span className="focus-input100"></span>
                                                <span className="symbol-input100">
                        ...
                        return (
                            <Header username={this.state.username} useravatar={this.state.useravatar} />
                        )
                    }
